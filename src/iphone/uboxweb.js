...
function changelinenum(This) {
  if (ubox.lines[This.value] == undefined) { alert('USB盒子未插入') } else { hdl = ubox.lines[This.value].handle }
}
...
function UploadFormFile() {
  ...
  var filename = 'E:\\usb\\usb开发例子\\ubox-websocket-server-2017-08-02\\bin\\test.wav'
 		var msg = {
  ...
  AppendStatus('upload formFile file')
  /*
