  ...
  <div class="touch_customers m98Auto">
    <div class="paddingTB20">
      <el-form :inline="true" :model="formInline" label-position="right" label-width="110px" size="mini" class="demo-form-inline">
        ...
        <el-form-item>
          <el-button type="primary" icon="el-icon-search" size="mini" @click="notSignedResource">查询</el-button>
        </el-form-item>
      </el-form>
    </div>
    <el-table
    ...
    <div class="pro_top_pagination">
      <el-pagination
        ...
        @current-change="notSignedResource"
      />
    </div>
  </div>
</template>
...
<script>
import { notSignedResource, labelCustomer, brandCustomer, regionCustomer } from '@/api/dhkfApi'
...
export default {
  ...
  methods: {
    notSignedResource(current) {
      const that = this
      return new Promise((resolve, reject) => {
        notSignedResource(that.paramFormat(current)).then(res => {
          const { data } = res
