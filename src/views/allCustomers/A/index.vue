  ...
  <div class="touch_customers m98Auto">
    <div class="paddingTB20">
      <el-form :inline="true" :model="formInline" label-position="right" label-width="110px" size="mini" class="demo-form-inline">
        ...
        <el-form-item>
          <el-button type="primary" icon="el-icon-search" size="mini" @click="allCustomer">查询</el-button>
        </el-form-item>
      </el-form>
    </div>
    <el-table
...
<script>
import { allCustomer, detailLabelCustomer, brandCustomer, regionCustomer } from '@/api/dhkfApi'
  ...
  methods: {
    allCustomer(current) {
      ...
      return new Promise((resolve, reject) => {
        allCustomer(that.paramFormat(current)).then(res => {
          const { data } = res
